...
Original file is located at
    https://colab.research.google.com/drive/15tlzB-BXTUZLJi9JWZHw1zRjBA37BLIr
...
def generate_df_ab_test(n_days=20):
  ...
  num_users = n_origin + n_varian
  userID = create_unique_user_ids(num_users)
