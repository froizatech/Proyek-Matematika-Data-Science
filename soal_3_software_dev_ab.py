...
Original file is located at
    https://colab.research.google.com/drive/1LkU_vx9Hna5WnKqWmmKyX_-agVAbzNrD
...
def estimate_sample_size_proportions(p1, p2, alpha=0.05, beta=0.20, two_sided=True):
    ...
    n = ((math.sqrt(p_bar*q_bar*(1+(1/k)))*z_alpha+math.sqrt(p1*q1+(p2*q2/k))*z_beta)**2)/delta**2
    # AKHIRI KODE DI SINI
...
n_days = math.ceil(2*3627/active_users_per_day) # Isi dengan perhitungan Anda
# AKHIRI KODE DI SINI
...
def z_statistic_diff_proportions(origin_metrics, varian_metrics):
  ...
  #Kelompok origin: n=3959, x=2734, dan p=0.6906
  #Kelompok varian: n=4041, x=2906, dan p=0.7191
  p = compute_pooled_proportion(origin_metrics, varian_metrics)
